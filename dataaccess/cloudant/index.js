...
export default function (settings) {
    ...
    module.insertOne = function (collectionname, doc) {
    ...
    module.findOne = function (collectionname, key) {
        return new Promise((resolve, reject) => {
    ...
    module.update = function (collectionname, doc) {
        return new Promise((resolve, reject) => {
    ...
    module.findBy = function (collectionname, condition) {
        return new Promise((resolve, reject) => {
    ...
    module.count = function (collectionname, condition) {
        return new Promise((resolve, reject) => {
            resolve(-1);
        })
    };
